...
Для начала попросить оценить данный код, почекать потенциальные ошибки. Дана схема на UIKit + Delegate где вся логика во вью контроллере. Задача - перенести логику из контроллера в ViewModel (MVVM) + Сделать общение через Combine.
